...
export const NeuralModal = ({ isOpen, onClose, title, children }: NeuralModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[200000] flex items-center justify-center p-4 sm:p-6 lg:p-12 animate-in fade-in duration-500 backdrop-blur-sm">
            {/* Backdrop */}
            ...
            <div className="relative w-full max-w-7xl bg-[#050505] border-2 border-primary/20 shadow-[0_0_120px_rgba(0,0,0,1)] group animate-in zoom-in-95 duration-1000" 
                ...
                {/* Header */}
                <div className="flex items-center justify-between p-8 border-b border-primary/20 bg-primary/5 relative z-20 overflow-hidden">
                ...
                <div className="flex items-center justify-between px-10 py-4 bg-primary/5 border-t border-primary/10 relative z-20 overflow-hidden">
